...
// {
//     // read encoder without the table

//     // read encoder
//     // static volatile int32_t lastRaw = digitalRead(pinA_);
//     // volatile int32_t  currentRaw = digitalRead(pinA_);
//     // volatile int32_t currentRawB = digitalRead(pinB_);
//     // if (currentRaw != lastRaw) {
//     //     if (currentRaw == currentRawB) {
//     //         encoderRaw_++;
//     //     }
//     //     else {
//     //         encoderRaw_--;
